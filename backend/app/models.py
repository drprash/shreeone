...
class User(Base):
    ...
    onboarding_completed = Column(Boolean, default=False, nullable=False)  # True once the welcome tour is done
    setup_checklist_dismissed = Column(Boolean, default=False, nullable=False)  # True if user dismissed the getting-started checklist
    created_at = Column(DateTime, default=datetime.utcnow)
    deleted_at = Column(DateTime, nullable=True)
